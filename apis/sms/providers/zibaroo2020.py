...
class SmsZibaroo2020(AbstractSmsProvider):
    name = "SMS Zibaroo2020"

    def send_request(self, phone: str) -> requests.Response:
        session = requests.Session()
        # Load the auth page to get security nonce
        page = "https://zibaroo2020.ir/auth/"
        ...
        post_url = "https://zibaroo2020.ir/wp-admin/admin-ajax.php"
        payload = {
